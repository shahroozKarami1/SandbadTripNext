...
import { CusCardDetails, CusCircleIcon, CusCircleOutLine } from "@/elements/CusComponets";
    ...
    <Box>
      <Container>
        <Box display={"flex"} flexDirection={"column"}>
          ...
          <Box>
            <Link href={"/UserReview"} style={{ fontWeight: "bold", fontSize: "0.90rem", borderBottom: "1px  solid  #000" }}>نوشتن بررسی </Link>
          </Box>
        </Box>
      </Container>
